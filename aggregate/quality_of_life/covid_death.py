...
def load_clean_source_data():
    ...
    #print(source_data)
    source_data.rename(columns={'PUMA': 'puma', 'Total\nDeaths': 'total_covid_death', 'Race/Ethnicity': 'race'}, inplace=True)
    ...
    source_data['total_covid_death'] = source_data['total_covid_death'].replace('*', np.nan)
